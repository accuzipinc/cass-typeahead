(function ($) {
    ...
    AZTypeAhead.prototype.init = function() {
        ...
        */
        if(this.options.geoBias && !this.options.ip){
            $.get('http://api.ipstack.com/check?access_key=8de5c979d396f99fde8346e23ffaf2c0&output=json&legacy=1', function(response) {
    ...
    */
    ...
    AZAddress.prototype.loadFromInputs  = function(){
        ...
        this.address2 = $('[data-' + this.options.dataKey + '-address2]').length ? $('[data-' + this.options.dataKey + '-address2]').val() : null;
